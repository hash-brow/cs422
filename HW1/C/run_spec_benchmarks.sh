...
run_benchmark() {
  ...
  local full_cmd
  touch "/home/ubuntu/cs422/HW1/C/results/${bench}_time.txt"
  touch "/home/ubuntu/cs422/HW1/C/results/${bench}.log"
  full_cmd="/usr/bin/time -o "/home/ubuntu/cs422/HW1/C/results/${bench}_time.txt" pin -t \"$MAIN_SO\" -f \"$fast_forward\" -o \"/home/ubuntu/cs422/HW1/C/results/${bench}.log\" -- $modified_cmd"
