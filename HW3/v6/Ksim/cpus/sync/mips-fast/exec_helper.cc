...
#define SIGN_EXTEND_IMM(x)   do { x <<= 16; x >>= 16; } while (0)
   ...
   case 4:			// beq
      ...
      de->_loWPort = FALSE;
      de->_memControl = FALSE;
      de->_branchOffset <<= 16; de->_branchOffset >>= 14; de->_bdslot = 1; de->_btgt = (unsigned)((signed)fd->_pc+de->_branchOffset+4);
      de->_src_reg[0] = i.imm.rs;
   ...
   case 2:			// j
      ...
      de->_loWPort = FALSE;
      de->_memControl = FALSE;
      de->_btgt = ((fd->_pc+4) & 0xf0000000) | (de->_branchOffset<<2); de->_bdslot = 1;
      break;
